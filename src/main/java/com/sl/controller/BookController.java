...
public class BookController {
    ...
    public RestModel<PageBean<BookPojo>> findAll(@RequestParam(defaultValue = "1", value = "pageNo") Integer pageNo, @RequestParam(value = "size", defaultValue = "10") Integer pageSize, @RequestParam(value = "typeId", defaultValue = "-1") Integer typeId) {
        PageBean<BookPojo> all = bookService.findAll(pageNo, pageSize, typeId);
        return new RestModel<>(200, "查询成功", all);
    }

    @GetMapping("/searchBook")
    public RestModel<PageBean<BookPojo>> fuzzyQueryBook(@RequestParam(defaultValue = "1", value = "pageNo") Integer pageNo,@RequestParam(value = "size", defaultValue = "10") Integer pageSize, @RequestParam(value = "search") String search, @RequestParam(value = "typeId", defaultValue = "-1") Integer typeId) {
